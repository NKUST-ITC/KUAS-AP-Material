...
public class MaterialProgressDrawable extends Drawable implements Animatable {
	 ...
	 *
	 * @param size One of {@link MaterialProgressDrawable.XLARGE} or
	 *             {@link MaterialProgressDrawable.LARGE} or
	...
	public void updateSizes(@ProgressDrawableSize int size) {
		...
		if (size == XLARGE) {
			setSizeParameters(CIRCLE_DIAMETER_XLARGE * screenDensity,
					CIRCLE_DIAMETER_XLARGE * screenDensity, CENTER_RADIUS_XLARGE * screenDensity,
					STROKE_WIDTH_XLARGE * screenDensity, ARROW_WIDTH_LARGE * screenDensity,
