...
public class ProgressWheel extends View {
	...
	private void setupBounds(int layout_width, int layout_height) {
		...
		if (!fillRadius) {
			...
			circleBounds2 = new RectF(xOffset + barWidth, yOffset + barWidth,
			...
			circleBounds2 =
					new RectF(paddingLeft + barWidth + xOffset, paddingTop + barWidth + yOffset,
	...
	private void parseAttributes(TypedArray a) {
		...
		circleColor =
				a.getColor(R.styleable.ProgressWheel_matProg_circleBackgroundColor, circleColor);
		isCircleBackground = a.getBoolean(R.styleable.ProgressWheel_matProg_circleBackground,
				isCircleBackground);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (isCircleBackground) {
			if (isShadow) {
				canvas.drawCircle(circleBounds2.centerX() + mShadowSize / 2,
						circleBounds2.centerY() + mShadowSize,
						circleBounds2.width() / 2 + mShadowSize / 2, shadowPaint);
			}
			canvas.drawCircle(circleBounds2.centerX(), circleBounds2.centerY(),
					circleBounds2.width() / 2, circlePaint);
		}
